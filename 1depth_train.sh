...
DATE=1029_new_depth_encoder_l1_l1
LR=1e-3

CUDA_VISIBLE_DEVICES=$DEVICES python depth_from_event_latents.py --date $DATE --loss_type l1 \
...
# DATE=1029_new_depth_encoder_l1_2_l1
# LR=1e-4
...
# DATE=1029_new_depth_encoder_l1_3_l1
# LR=5e-4
...
# DATE=1029_new_depth_encoder_l1_4_l1
# LR=2e-5
